 ...
 */ 
var DishInfoImage = function (container, model) {
	 ...
	 */
	 ...
	 //Försök för att anpassa för om vi tittar ju just french toast och ska printa ut toast
	 // Eller om vi ska printa ut bilderna från menyn
    ...
    //	foo.appendChild(img_temp);
	 //}
	 //else if(model.getFullMenu().length != 0){
	 //	var menu = model.getFullMenu();
	 //	for(im in menu){
	 //		var img_temp=document.createElement("img");
	//		img_temp.src= "images/";
    //		img_temp.src+= menu[im];
    //		img_temp.id="picture";
    //		var foo = document.getElementById("fooBar");
    //		foo.appendChild(img_temp);
	 //	}

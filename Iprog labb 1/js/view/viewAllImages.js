 ...
 */ 
var ViewAllImages = function (container, model) {
	 ...
	 */
	 ...
	 var images = container.find("#displayAllImages");
	 //dishes.html(model.getDishes());
	 var temp_array = model.getImages();

	 for (im in temp_array){

	 	//Försök för att skapa div med kolumner klasser:

	 	//var div_temp=document.createElement("div");
	 	//div_temp.class= "col-lg-1 col-md-1 col-sm-3 col-xs-3";
	 	//var foo_div = document.getElementById("foo_div");
	 	//foo_div.append(div_temp);


	 	var img_temp=document.createElement("img");
		img_temp.src= "images/";
    	img_temp.src+= temp_array[im];
    	//img_temp.id="picture";
    	var foo = document.getElementById("fooBar");
    	foo.appendChild(img_temp);

	 	//images.html(temp_array[img]);
	 	//images.html(model.getImages());
	 }
